...
('计算机基础实验室', 'LAB001', '科技楼301', 50, '计算机实验室', 1, NULL, '用于计算机基础课程教学，配备50台台式电脑'),
('计算机网络实验室', 'LAB002', '科技楼402', 40, '计算机实验室', 1, NULL, '用于计算机网络课程教学，配备网络设备和服务器'),
('电子电路实验室', 'LAB003', '实验楼201', 30, '电子实验室', 1, NULL, '用于电子电路实验，配备示波器、信号发生器等设备'),
('物理实验实验室', 'LAB004', '实验楼305', 25, '物理实验室', 1, NULL, '用于大学物理实验教学'),
('机械工程实验室', 'LAB005', '工程楼101', 20, '机械实验室', 2, NULL, '用于机械工程实验，目前维护中');
